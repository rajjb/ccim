...
async function main() {
    ...
    console.log(`Deposit Market Size : $${formatMoney(totalSupply)}`);
    console.log(`Borrow Market Size : $${formatMoney(totalBorrow)}`);
    console.log(`TVL : $${formatMoney(totalCash)}`);
    _print("");
...
async function printData(data) {
    console.log(`${data.underlyingSymbol} ($${formatMoney(data.underlyingPrice)})`);
