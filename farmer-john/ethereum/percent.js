...
async function loadPool(App, tokens, prices, stakingAddress, rewardTokenTicker, rewardTokenAddress) {
  ...
  console.log(`Stake ${userUnstaked.toFixed(2)} ${stakingTokenTicker}`, approveTENDAndStake)
  console.log(`Unstake ${userStaked.toFixed(2)} ${stakingTokenTicker}`, unstake)
  console.log(`Claim ${earned.toFixed(2)} ${rewardTokenTicker}`, claim)
