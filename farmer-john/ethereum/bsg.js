...
async function loadBoardroom_(App, prices, boardroomAddress, oracleAddress, lptAddress, rewardTokenAddress, stakeTicker, rewardTicker,
    ...
    console.log(`Stake ${userUnstaked.toFixed(decimals)} ${stakeTicker}`, approveTENDAndStake)
    console.log(`Unstake ${userStaked.toFixed(decimals)} ${stakeTicker}`, unstake)
    console.log(`Claim ${earned.toFixed(decimals)} ${rewardTicker}`, claim)
