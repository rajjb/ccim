$(function() {
  ...
  async function main() {
    ...
    console.log(`Stake ${unstakedY} ${stakingTokenTicker}`, approveTENDAndStake)
    console.log(`Unstake ${stakedYAmount} ${stakingTokenTicker}`, unstake)
    console.log(`Claim ${earnedYFFI} ${rewardTokenTicker}`, claim)
