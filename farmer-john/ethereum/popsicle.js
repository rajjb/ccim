...
async function main() {
  ...
  console.log("The following farms have been DISCONTINUED. You can unstake at any time.\n")
  ...
  console.log(`Total Staked: $${formatMoney(p0.totalStaked + p1.totalStaked + p2.totalStaked)}`);
