...
console.log(`Claim ${info.earned0.toFixed(6)} ${info.rewardTokenTicker0} ($${formatMoney(info.earned0*info.rewardTokenPrice0)}), ${info.earned1.toFixed(6)} ${info.rewardTokenTicker1} ($${formatMoney(info.earned1*info.rewardTokenPrice1)})`, claim)
