...
async function printNonGeyserPool(App, tokens, prices, pool, sharesPerFragment) {
  ...
  console.log(`Stake ${userTotallyUnstaked.toFixed(12)} ${lpToken.symbol}`, approveUNIAndStake)
  console.log(`Unstake ${userUnstaked.toFixed(12)} ${lpToken.symbol}`, unstakeUNI)
  _print(`\n`);
}
...
async function printPool(App, tokens, prices, pool, sharesPerFragment) {
  ...
  console.log(`Stake ${userTotallyUnstaked.toFixed(12)} ${lpToken.symbol}`, approveUNIAndStake)
  console.log(`Unstake ${userUnstaked.toFixed(12)} ${lpToken.symbol}`, unstakeUNI)
  console.log(`Stake ${userUnstaked.toFixed(12)} ${settToken.symbol}`, approveTENDAndStake)
  console.log(`Unstake ${userStaked.toFixed(12)} ${settToken.symbol}`, unstake)
