...
consoleInit(main)
  ...
  async function loadPool(App, tokens, prices, stakingAddress) {
    ...
    console.log(`Stake ${userUnstaked.toFixed(6)} ${stakingTokenTicker}`, approveTENDAndStake)
    console.log(`Unstake ${userStaked.toFixed(6)} ${stakingTokenTicker}`, unstake)
    console.log(`Claim ${earned.toFixed(6)} ${rewardTokenTicker}`, claim)
