...
consoleInit(main)
  ...
  async function loadPool(App, prices, tokens, poolIndex,
    ...
    console.log(`Stake ${poolToken.unstaked.toFixed(2)} ${pp.stakingTokenTicker}`, approveAndStake)
    console.log(`Unstake ${userStaked.toFixed(2)} ${pp.stakingTokenTicker}`, unstake)
    console.log(`Claim ${rewardEarned.toFixed(2)} ${rewardTokenTicker}`, claim)
    _print(`\n`);
  }
