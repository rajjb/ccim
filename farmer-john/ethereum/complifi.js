...
async function printComplifiPool(App, chefAbi, chefAddr, prices, tokens, poolInfo, poolIndex, poolPrices,
  ...
  console.log(`Stake ${userUnstaked.toFixed(fixedDecimals)} ${poolPrices.stakeTokenTicker}`, approveAndStake)
  console.log(`Unstake ${userStaked.toFixed(fixedDecimals)} ${poolPrices.stakeTokenTicker}`, unstake)
