...
module.exports = async function main() {
  ...
  const result = await loadBscAUTOChefContract(App, tokens, prices, AUTOFARM_CHEF, AUTOFARM_CHEF_ADDR, AUTOFARM_CHEF_ABI, rewardTokenTicker,
